...
**Tip:** There is another file, called `config.cfg`{.filename} that is
...
There are a number of settings (“variables”) you can configure. For
...
To set up a serial speech synthesiser or Braille display, you will need
